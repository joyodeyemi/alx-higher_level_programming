...
In this project, I started my practice on object-oriented programming using classes and objects in Python. I learned about attributes, methods, properties, data abstraction, data encapsulation, and information hiding.
